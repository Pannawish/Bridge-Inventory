          ...
          >
            ...
            <div className="supplier-preview-grid">
              <article className="supplier-preview-card">
                ...
                <strong>
                  {getSelectedValue(
                    draftSupplier.locations,
                    draftSupplier.selectedLocationIndex
                  )}
                </strong>
              </article>
              <article className="supplier-preview-card">
                ...
                <strong>
                  {getSelectedValue(draftSupplier.emails, draftSupplier.selectedEmailIndex)}
                </strong>
              </article>
              <article className="supplier-preview-card">
                <span>Selected Tel</span>
                <strong>
                  {getSelectedValue(draftSupplier.tels, draftSupplier.selectedTelIndex)}
                </strong>
              </article>
              <article className="supplier-preview-card">
                <span>Selected Branch</span>
                <strong>
                  {getSelectedValue(draftSupplier.branches, draftSupplier.selectedBranchIndex)}
                </strong>
              </article>
            </div>
