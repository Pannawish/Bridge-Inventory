...
class Command(BaseCommand):
    ...
    def seed_categories(self):
        specs = [
            ("Office Supplies", "Core replenishment goods used across departments.", None),
            ...
            ("Packaging", "Tape, cartons, mailers, labels, and wrap.", None),
            ("Electronics", "Small electronics and cable accessories.", None),
            ("Printer Supplies", "Ink, toner, maintenance parts, and paper feed supplies.", "Electronics"),
            ("Cleaning & Pantry", "Consumables for pantry and common areas.", None),
            ("Safety Stock", "Safety and facility consumables.", None),
            ("Event Materials", "Supplies commonly used for events and training.", None),
        ]
        categories = {}
