...
\begin{tikzpicture}[
	...
	workflowstep/.style={rectangle, draw=black, thick, align=center, minimum width=2.45cm, minimum height=0.85cm, fill=gray!10},
	...
	\node[workflowstep] (master) {Master Data\\Products, Partners};
