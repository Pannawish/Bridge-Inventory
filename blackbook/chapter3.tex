...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{3.1cm}|p{3.2cm}|X|}
		...
		Operation summary & Dashboard & Shows stock, finance, order coverage, trends, and movement summaries from backend data. \\ \hline
		...
		Purchasing & Purchases & Records purchase orders, purchase items, receiving status, documents, VAT totals, discounts, and payable values. \\ \hline
		Supplier payment & Payment Batches & Groups eligible purchases into supplier payment batches and tracks paid or unpaid lines. \\ \hline
		...
		Sales & Sales & Records customer sales, line items, stock allocation, delivery status, documents, VAT totals, and credit-note links. \\ \hline
		...
		Supplier records & Supplier & Manages supplier profile data, contact information, procurement contact, branches, shipping addresses, and terms. \\ \hline
		Customer records & Customer & Manages customer profile data, contact information, branches, shipping addresses, and billing terms. \\ \hline
	\end{tabularx}
\end{table}
...
\max(0,\ \text{Reorder Level} + \text{Pending Sales} + \text{Oversold Units} - \text{Available Stock} - \text{Pending Purchases})
\]
