...
\begin{table}[!htbp]
	...
	\begin{tabular}{|p{2.5cm}|c|c|c|c|c|c|c|c|c|c|}
		\hline
		\multicolumn{1}{|c|}{} & \multicolumn{10}{c|}{\textbf{Timeline}} \\ \cline{2-11}
		\multicolumn{1}{|c|}{} & \multicolumn{4}{c|}{\textbf{2025}} & \multicolumn{6}{c|}{\textbf{2026}} \\ \cline{2-11}
		\multicolumn{1}{|c|}{\multirow{-3}{2cm}{\textbf{Plan}}} & \textbf{Sep} & \textbf{Oct} & \textbf{Nov} & \textbf{Dec} & \textbf{Jan} & \textbf{Feb} & \textbf{Mar} & \textbf{Apr} & \textbf{May} & \textbf{Jun} \\ \hline
		1: Initiation & 
