...
Figure~\ref{fig:user-access-page} shows the user access page where authorized administrators can create staff accounts, assign roles, update account status, and review role permissions.
...
Figure~\ref{fig:activity-log-page} shows the activity log page where authorized users can review important system events such as login, create, update, and delete actions.
