...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{3.2cm}|X|p{2.7cm}|}
		...
		AI Chat & Supports selected read-only text questions using backend data: stock and fulfillment, customer or supplier summaries, receivable and payable exceptions, and reference or line-item lookup. It does not create or update records. & Implemented \\ \hline
	\end{tabularx}
\end{table}
...
\caption{Read-only inventory assistant}
...
\subsection{Dashboard and Assistant Results}
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{4cm}|X|}
		...
		Assistant & Chat endpoint builds compact backend context and returns text responses for supported read-only operational questions. \\ \hline
	\end{tabularx}
\end{table}
