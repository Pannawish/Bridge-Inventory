...
\section{Business Calculation Formulas}
This section describes the main calculation logic that is implemented in the web application. Equations~\ref{eq:lead-time-demand} to~\ref{eq:stock-value} are connected to inventory management ideas from \textit{Essentials of Inventory Management}, especially demand, replenishment planning, safety stock, and inventory value \cite{paper_2}. The other formulas are project-specific transaction and finance rules used by this system.
