...
The system also supports receivable and payable workflows. Billing notes are created from eligible sales, payment batches are created from eligible purchases, and credit notes are created from eligible cancelled or returned sale lines. The dashboard and AI assistant provide summary views and natural-language access to operational data.
...
\begin{enumerate}
	...
	\item AI-assisted text queries can improve access to operational information, but they must be grounded in backend data to avoid unsupported answers.
\end{enumerate}
...
\begin{enumerate}
	...
	\item Improve AI assistant evaluation by comparing answers against expected backend records.
