...
- When linking to other codebase documents or files within any `.md` file, always use **relative repository links** (e.g., `./docs/business/business-rules-reference.md`) instead of absolute local file system paths. This ensures the links redirect successfully for contributors navigating the repository on GitHub.
